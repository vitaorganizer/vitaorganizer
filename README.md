...
In other cases, you can run it with `java -jar vitaorganizer-0.5.jar`

You can download a prebuild binary here, or just build from source:
[Download VitaOrganizer 0.5 here](https://github.com/soywiz/vitaorganizer/releases/download/0.5/vitaorganizer-0.5.jar)
